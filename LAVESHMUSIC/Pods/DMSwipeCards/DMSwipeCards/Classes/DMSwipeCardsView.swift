...
public class DMSwipeCardsView<Element>: UIView {
    ...
    public func getCardViewOnTheTop() -> UIView
    {
        return self.topCardView.viewWithTag(LM_CARD_CONTAINER_TAG)!
    }
    ...
    self.isUserInteractionEnabled = true
        ...
        self.topCardView = self.loadedCards.first!
...
extension DMSwipeCardsView: DMSwipeCardDelegate {
    ...
    func cardSwipedUp(_ card: DMSwipeCard) {
        self.delegate?.swipedUp(card.obj)
    }
